...
etaH = 0.0; % L2 regularization on fileds h
etaJ = 0.005; % L2 regularization on couplings J

etaMat = diag( [ etaH * zeros([N 1]) ; etaH * zeros([N*(N-1)/2 1])   ]  ); % L2 regularization as big matrix
...
if 0
    ...
    save([filePath 'IsingInference.mat'],'eta','jList','p','q','output');
end
